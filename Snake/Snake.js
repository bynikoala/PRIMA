    ...
    class Snake extends ƒ.Node {
        ...
        move() {
            ...
            while (true) {
                ...
                let cubeCorner = ƒ.Vector3.ONE(Snake_1.size + 0.5);
        ...
        eat() {
            ...
            for (let item of Snake_1.items.getChildren()) {
                if (posHead.isInsideSphere(item.mtxLocal.translation, 0.5)) {
                    Snake_1.items.removeChild(item);
                    this.grow(1);
                }
            }
        }
        ...
        createSegment(_color = this.color) {
            ...
            let cmpMaterial = new ƒ.ComponentMaterial(Snake_1.mtrStandard);
